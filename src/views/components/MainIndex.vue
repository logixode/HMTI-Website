<template>
  <section class="section section-lg section-shaped overflow-hidden my-0">
    ...
    <div class="container py-2 pb-lg">
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-5 mb-5 mb-lg-0">
          <h2 class="text-white font-weight-bold">HIMPUNAN MAHASISWA</h2>
          <h4 class="text-white">TEKNIK INFORMATIKA - POLIWANGI</h4>
          <p
          ...
          <router-link to="tentang" class="btn btn-white mt-4 text-uppercase px-5">Lihat Profile</router-link>
